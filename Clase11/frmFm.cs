    ...
    public partial class frmFm : System.Windows.Forms.Form
    {
        ...
        private void btnExportarExcel_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.OK)
            {
                ...
                try
                {
                    Tools.ExportarTreeViewExcel(this.trvHabitaciones, rutaArchivo, _doc);
                    MessageBox.Show("La Planilla se exportó correctamente", "Facility Management",
                        MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                catch (Exception ex)
                {
                    MessageBox.Show("Error: " + ex.Message, "Facility Management",
                       MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
        }
